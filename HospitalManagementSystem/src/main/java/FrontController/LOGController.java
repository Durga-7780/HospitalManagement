...
import EntityClasses.Test;
import ServiceClasses.CrudService;
...
//	registration validation username
	@RequestMapping(path="/checkUser/{user}",method=RequestMethod.POST)
...
//	---------------------------------------------------------Main------------------------------------------------------------
	...
	//	Login validation	
		@RequestMapping(path="/checkLoginDetails/{user}/{pass}",method=RequestMethod.POST)
...
//	Dashboard
	...
	@GetMapping(path="/dashboard/{user}/{pass}")
    public String dashboardWithDetails(@PathVariable("user") String username,@PathVariable("pass") String pass,Model model) {
	 	user=username;
